...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [COLEMAK] = LAYOUT_moonlander(
        ...
        CAPS_WORD,      KC_Q,           KC_W,           KC_F,           KC_P,           KC_G,           TO(COLORS),                             XXXXXXX,        KC_J,           KC_L,           KC_U,           KC_Y,           KC_SCOLON,      KC_BSLASH,
        ...
        KC_LALT,        KC_LEFT,        KC_RIGHT,       KC_LGUI,        KC_GRAVE,                       TD1,                                    TD2,                            KC_LBRACKET,    KC_RBRACKET,    KC_UP,          KC_DOWN,        TO(GIT),
    ...
    [BOARD] = LAYOUT_moonlander(
        ...
        _______,        _______,        _______,        _______,        _______,        _______,                                                                _______,        _______,        _______,        _______,        _______,        _______,
        _______,        _______,        _______,        _______,        _______,                        _______,                                QK_MAKE,                        _______,        _______,        _______,        _______,        _______,
                                                                        _______,        _______,        TO(COLEMAK),                            DB_TOGG,        EE_CLR,         _______
    ),
    [COLORS] = LAYOUT_moonlander(
        _______,        _______,        _______,        _______,        _______,        _______,        _______,                                _______,        _______,        _______,        _______,        _______,        _______,        _______,
        _______,        _______,        _______,        _______,        _______,        _______,        _______,                                _______,        _______,        RGB_MOD,        RGB_RMOD,       _______,        _______,        _______,
        _______,        RGB_M_R,        RGB_M_B,        RGB_M_SN,       RGB_M_P,        RGB_SPI,        _______,                                _______,        RGB_TOG,        RGB_HUI,        RGB_SAI,        RGB_VAI,        _______,        _______,
        _______,        _______,        _______,        _______,        RGB_M_K,        RGB_SPD,                                                                _______,        RGB_HUD,        RGB_SAD,        RGB_VAD,        _______,        _______,
        _______,        _______,        _______,        _______,        _______,                        _______,                                TO(COLEMAK),                    _______,        _______,        _______,        _______,        _______,
                                                                        _______,        _______,        _______,                                _______,        _______,        _______
    ),
    [GIT] = LAYOUT_moonlander(
        _______,        _______,        _______,        _______,        _______,        _______,        _______,                                G_INIT,         G_CLONE,        G_REMTE,        _______,        _______,        _______,        _______,
        _______,        _______,        _______,        _______,        _______,        _______,        _______,                                G_CONF,         _______,        G_FETCH,        G_MERGE,        G_CHECK,        _______,        _______,
        _______,        _______,        _______,        _______,        _______,        _______,        _______,                                _______,        G_COMM,         G_PULL,         G_PUSH,         G_STAT,         _______,        _______,
        _______,        _______,        _______,        _______,        _______,        _______,                                                                G_BRANH,        G_ADD,          G_DIFF,         G_REBAS,        _______,        _______,
        _______,        _______,        _______,        _______,        _______,                        _______,                                G_QK_BOOT,                      _______,        _______,        _______,        _______,        _______,
                                                                        _______,        _______,        _______,                                TO(COLEMAK),    _______,        G_LOG
    ),
};
...
const ledmap PROGMEM ledmaps[] = {
    [COLEMAK] = RGB_MATRIX_LAYOUT_LEDMAP(
        ...
        MAGENT,         RED,            RED,            RED,            RED,            RED,            CORAL,                                  ______,         RED,            RED,            RED,            RED,            RED,            RED,
        ...
        BLUE,           CHART,          CHART,          BLUE,           RED,                            CORAL,                                  CORAL,                          RED,            RED,            CHART,          CHART,          CORAL,
    ...
    [COLORS] = RGB_MATRIX_LAYOUT_LEDMAP(
        RED,            RED,            RED,            RED,            RED,            RED,            RED,                                    RED,            RED,            RED,            RED,            RED,            RED,            RED,
        RED,            RED,            RED,            RED,            RED,            RED,            RED,                                    RED,            RED,            YELLOW,         YELLOW,         RED,            RED,            RED,
        RED,            GREEN,          GREEN,          GREEN,          BLACK,          YELLOW,         RED,                                    RED,            YELLOW,         TURQ,           TEAL,           CYAN,           RED,            RED,
        RED,            RED,            RED,            RED,            GREEN,          YELLOW,                                                                 RED,            TURQ,           TEAL,           CYAN,           RED,            RED,
        RED,            RED,            RED,            RED,            RED,                            RED,                                    GREEN,                          RED,            RED,            RED,            RED,            RED,
                                                                        RED,            RED,            RED,                                    RED,            RED,            RED
    ),
    [GIT] = RGB_MATRIX_LAYOUT_LEDMAP(
        RED,            RED,            RED,            RED,            RED,            RED,            RED,                                    CYAN,           CYAN,           CYAN,           RED,            RED,            RED,            RED,
        RED,            RED,            RED,            RED,            RED,            RED,            RED,                                    CYAN,           RED,            CYAN,           CYAN,           CYAN,           RED,            RED,
        RED,            RED,            RED,            RED,            RED,            RED,            RED,                                    RED,            CYAN,           CYAN,           CYAN,           CYAN,           RED,            RED,
        RED,            RED,            RED,            RED,            RED,            RED,                                                                    CYAN,           CYAN,           CYAN,           CYAN,           RED,            RED,
        RED,            RED,            RED,            RED,            RED,                            RED,                                    CYAN,                           RED,            RED,            RED,            RED,            RED,
                                                                        RED,            RED,            RED,                                    GREEN,          RED,            CYAN
    ),
};
